...
class sprite_component_desc_ptr(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, sprite_component_desc_ptr, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, sprite_component_desc_ptr, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _FEX.new_sprite_component_desc_ptr()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _FEX.delete_sprite_component_desc_ptr
    __del__ = lambda self : None;
sprite_component_desc_ptr_swigregister = _FEX.sprite_component_desc_ptr_swigregister
sprite_component_desc_ptr_swigregister(sprite_component_desc_ptr)

class spritebase_ptr(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, spritebase_ptr, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, spritebase_ptr, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _FEX.new_spritebase_ptr()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _FEX.delete_spritebase_ptr
    __del__ = lambda self : None;
...
def pick_sprite(*args):
  return _FEX.pick_sprite(*args)
pick_sprite = _FEX.pick_sprite

def get_raw_ptr(*args):
  return _FEX.get_raw_ptr(*args)
get_raw_ptr = _FEX.get_raw_ptr
...
class SpriteComponent(_object):
    ...
    def init_physics(self, *args): return _FEX.SpriteComponent_init_physics(self, *args)
...
class ResourceManager(_object):
    ...
    def get_sprite_desc(self, *args): return _FEX.ResourceManager_get_sprite_desc(self, *args)
    def get_sprite_component_desc(self, *args): return _FEX.ResourceManager_get_sprite_component_desc(self, *args)
    def get_animation(self, *args): return _FEX.ResourceManager_get_animation(self, *args)
